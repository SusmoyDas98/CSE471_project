...
<head>
    ...
    <title>Dorm Seeker Dashboard</title>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <div class="navbar-nav ms-auto align-items-center">
                ...
                <a class="nav-link {{ request()->routeIs('seeker.vacancies.*') ? 'active' : '' }}" href="{{ route('seeker.vacancies.index') }}">Search Dorms</a>
                <a class="nav-link {{ request()->routeIs('profile.*') ? 'active' : '' }}" href="{{ route('profile.preferences.edit') }}">My Profile</a>
                @php
                    $totalNotifications = \App\Models\Application::where('user_id', auth()->id())
                        ->whereIn('status', ['submitted', 'reviewing', 'accepted', 'rejected'])
                        ->where('updated_at', '>', now()->subDays(7))
                        ->count();
                @endphp
                <a class="notification-icon" href="{{ route('seeker.applications.index') }}" title="Notifications">
                ...
                <a href="{{ route('seeker.vacancies.index') }}" class="btn-browse">
...
<div class="container mb-5">
    ...
    @endif
    @if($errors->any())
        <div class="alert alert-danger alert-dismissible fade show mt-4" role="alert" style="border-radius: 16px; border: 2px solid #dc3545;">
