...
<div class="container py-5">
    <div class="text-center mb-5">
        <h1 style="font-family: 'Playfair Display', serif; font-weight: 700; color: var(--primary);">Available Dorms</h1>
                        ...
                        <div class="dorm-card-body">
                            ...
                            <div class="mb-3">
                                @if($dorm->avg_rating)
                                    ...
                                    <span class="text-secondary ms-1">({{ number_format($dorm->avg_rating, 1) }}) - {{ $dorm->review_count }} reviews</span>
                                @else
